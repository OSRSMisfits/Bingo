...
<template>
    ...
    <div :class="{ 'rules-overlay': true, show: renderRules, background: !showRules }" @click="closeRules">
        <ol class="rules-list">
            <li class="rule">All screenshots must include the phrase word that will be given once the event starts. If the phrase isn’t in the screenshot. The drop does not count.  Code Word: <strong>merica250</strong></li>
